...
if selected=='Experience':
   ...
   st.caption("⚒️  Providing strategic roadmap & tactical assistance to senior directors and AVP, helping them to shape key initiatives for fuelling organizational growth through Data Initiatives/Products/Platforms.")
   st.caption("⚒️  Day to day activities involves participating in agile ceremony & addressing doubts on requirements, talking with the stakeholder & converting the technical requirement into business requirement. Addressing concerns/questions on the products from stakeholders. Showcasing the demo of the newly introduced features. Market Research & create marketing contents for the product")
